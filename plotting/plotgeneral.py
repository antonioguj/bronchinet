...
class PlotGeneral(object):
    ...
    def plot_images_masks_all_slices(cls,
        ...
        for n in range(num_figures_saved):
            indexes_slices = np.linspace(count_slice, count_slice + range_slices_figure, num=cls._max_plot_images_figure + 1, dtype=int)[:-1]
    ...
    def plot_compare_images_masks_all_slices(cls,
        ...
        count_slice = 0
        for n in range(num_figures_saved):
            indexes_slices = np.linspace(count_slice, count_slice + range_slices_figure, num=cls._max_plot_images_axfigy_2 + 1, dtype=int)[:-1]
