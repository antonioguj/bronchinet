...
LARGER_NAME_GPU_INSTALLED = 'Quadro P6000'
SMALLER_NAME_GPU_INSTALLED = 'GeForce GTX 1080 Ti'
#SMALLER_NAME_GPU_INSTALLED = 'GeForce GTX 1070'
LARGER_IDDEVICE_GPU_INSTALLED = '0'
SMALLER_IDDEVICE_GPU_INSTALLED = '1'


class CPUdevicesManager:
...
def set_session_in_selected_device(use_GPU_device=False,
    ...
    if use_GPU_device:
        ...
        GPUdevicesManager.set_session_using_1gpu_device(type_gpu_installed=type_GPU_installed)
        #GPUdevicesManager.set_session_using_2gpus_device()
    else:
        CPUdevicesManager.set_session_using_cpu_device()
