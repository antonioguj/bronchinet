...
ARGUMENTS_TESTING = {'--basedir' : TESTSDIR,
                     ...
                     '--predictAccuracyMetrics' : 'BinaryCrossEntropy',
                     '--slidingWindowImages': 'True',
                     '--prop_overlap_Z_X_Y': '0.75, 0.0, 0.0'}
...
# ********** MANAGE OUTPUT FILES **********
script_CleanResultsDir = joinpathnames(CODEDIR, 'PredictionModel.py')

Popen_obj = subprocess.Popen(['python', script_CleanResultsDir] + ['--resultsdir', RESULTDIR])
