...
# Get the file list:
listImagesFiles      = sorted(glob(RawImagesFilesPath + '/av*.dcm'))
listMasksFiles       = sorted(glob(RawMasksFilesPath + '/av*seg.dcm' ))
listCenterlinesFiles = sorted(glob(MatLabCenterlinesFilesPath + '/av*centerlines.mat'))
