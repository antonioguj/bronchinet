...
SCRIPT_POSTPROCESSPREDICTIONS      = join_path_names(CODEDIR, 'scripts_airway_segmentation/postprocess_predictions.py')
SCRIPT_PROCESSPREDICTAIRWAYTREE    = join_path_names(CODEDIR, 'scripts_airway_segmentation/process_predict_airway_tree.py')
SCRIPT_EXTRACTCENTRELINESFROMMASKS = join_path_names(CODEDIR, 'scripts_util/apply_operation_images.py')
SCRIPT_CACLFIRSTCONNREGIONFROMMASKS= join_path_names(CODEDIR, 'scripts_util/apply_operation_images.py')
SCRIPT_COMPUTERESULTMETRICS        = join_path_names(CODEDIR, 'scripts_airway_segmentation/compute_result_metrics.py')
