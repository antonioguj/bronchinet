...
def main(args):
    ...
    if (is_load_reference_cenlines_files):
        ...
        input_reference_centrelines_path       = workdir_manager.get_datafile_exist(args.name_input_reference_centrelines_relpath)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--metric_eval_threshold', type=str, default='AirwayVolumeLeakage')
