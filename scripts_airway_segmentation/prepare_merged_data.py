...
if __name__ == "__main__":
    ...
    if args.type_data == 'training':
        ...
        message = 'Input param \'typedata\' = \'%s\' not valid, must be inside: \'%s\'...' % (args.type, LIST_TYPE_DATA_AVAIL)
        catch_error_exception(message)
    ...
    if args.type_distribute == 'orderfile' and not args.infile_order:
        message = 'Input \'infile_order\' file for \'fixed-order\' data distribution is needed...'
        catch_error_exception(message)
