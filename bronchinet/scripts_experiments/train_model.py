...
from common.constant import BASEDIR, SIZE_IN_IMAGES, NAME_TRAININGDATA_RELPATH, NAME_VALIDATIONDATA_RELPATH, \
                            ...
                            TYPE_DNNLIB_USED, IS_RESTART_ONLY_WEIGHTS, IS_MERGE_TWO_IMAGES_AS_CHANNELS, \
                            LAYERS_VGG16_LOSS_PERCEPTUAL, WEIGHTS_VGG16_LOSS_PERCEPTUAL, \
                            PROP_REDUSIZE_VGG16_LOSS_PERCEPTUAL
