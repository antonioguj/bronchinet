...
def main(args):
    ...
    print("Clean the directory: \'%s\'..." %(args.results_dir))

    list_all_files = list_files_dir_old(args.results_dir)
    list_models_files = list(list_all_files)

    name_loss_history_file = join_path_names(args.results_dir, name_rel_loss_history_file)
    name_link_model_last_epoch = join_path_names(args.results_dir, name_link_rel_model_last_epoch)
    name_link_model_min_loss = join_path_names(args.results_dir, name_link_rel_model_min_loss)
    name_link_model_min_valoss = join_path_names(args.results_dir, name_link_rel_model_min_valoss)
