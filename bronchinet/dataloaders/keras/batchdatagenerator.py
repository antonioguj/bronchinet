...
class TrainBatchImageDataGenerator_ManyImagesPerLabel(BatchImageDataGenerator_ManyImagesPerLabel, Sequence_keras):
    ...
    def __len__(self) -> int:
        return super(TrainBatchImageDataGenerator_ManyImagesPerLabel, self).__len__()

    def _on_epoch_end(self) -> None:
        super(TrainBatchImageDataGenerator_ManyImagesPerLabel, self)._on_epoch_end()

    def __getitem__(self, index: int) -> Tuple[np.ndarray, np.ndarray]:
        (out_Xdata, out_Ydata) = super(TrainBatchImageDataGenerator_ManyImagesPerLabel, self).__getitem__(index)
        return (out_Xdata.astype(dtype=self._type_data_generated),
                out_Ydata.astype(dtype=self._type_data_generated))
