...
def main(args):
    ...
    for i, in_posteriors_file in enumerate(list_input_posteriors_files):
        ...
        in_reference_mask_file = find_file_inlist_same_prefix(basename(in_posteriors_file), list_input_reference_masks_files,
        ...
        casename = get_substring_filename(basename(in_posteriors_file), substr_pattern=pattern_search_input_files)
