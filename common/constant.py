...
NAME_SAVEDMODELS_EPOCHS_KERAS = 'model_e{epoch:02d}.hdf5'
NAME_SAVEDMODELS_LAST_KERAS   = 'model_last.hdf5'
NAME_SAVEDMODELS_EPOCHS_TORCH = 'model_e%0.2i.pt'
NAME_SAVEDMODELS_LAST_TORCH   = 'model_last.pt'
