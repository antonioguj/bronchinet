...
import torch
from Networks_Pytorch.GNNUtil.gnnModules import NodeGNN
from scipy.sparse import load_npz
from Networks_Pytorch.GNNUtil.graphProcessing import makeAdjacency, compute_ontheflyAdjacency,\
    compute_ontheflyAdjacency_Torch, GenOntheflyAdjacency_NeighCandit
...
class Unet3DGNN_AllskipGNNs(NeuralNetwork):
    ...
    def __init__(self, size_image,
        ...
        list_filename_adjs = [joinpathnames(source_dir_adjs, filename) for filename in list_filename_adjs]
