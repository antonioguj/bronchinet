...
class LoadDataManagerInBatches(LoadDataManager):
    ...
    def loadData_1File(self, images_file, masks_file, max_num_images=10000, shuffle_images=True):
    ...
    def loadData_ListFiles(self, listImagesFiles, listMasksFiles, max_num_images=10000, shuffle_images=True):
