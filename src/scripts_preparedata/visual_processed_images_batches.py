...
from common.constant import DATADIR, SIZE_IN_IMAGES, NAME_PROC_IMAGES_RELPATH, NAME_PROC_LABELS_RELPATH, \
    ...
    IS_TRANSFORM_RIGID_IMAGES, TRANS_RIGID_ROTATION_RANGE, TRANS_RIGID_SHIFT_RANGE, TRANS_RIGID_FLIP_DIRS, \
    TRANS_RIGID_ZOOM_RANGE, TRANS_RIGID_FILL_MODE, IS_TRANSFORM_ELASTIC_IMAGES, TYPE_TRANS_ELASTIC_DEFORM, \
