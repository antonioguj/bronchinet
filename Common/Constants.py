...
CROPIMAGES = True
ISSAMEBOUNDBOXSIZEALLIMAGES = True
#CROPSIZEBOUNDINGBOX = (240, 352, 480)
#FIXEDSIZEBOUNDINGBOX = (352, 480)
FIXEDSIZEBOUNDINGBOX = (384, 544)
ISCALCBOUNDINGBOXINSLICES = True

SLIDINGWINDOWIMAGES = True
SLIDEWIN_PROPOVERLAP_Z_X_Y = (0.3, 0.0, 0.0)
#SLIDEWIN_PROPOVERLAP_Z_X_Y = (0.25, 0.25, 0.25)
#SLIDEWIN_PROPOVERLAP_Z_X_Y = (0.5, 0.5, 0.5)

RANDOMIMAGEGENERATION = True
NUMPATCHESTOTAL = 100
