    ...
    with tqdm(total=num_validpred_files) as progressbar:
        for i, in_posterior_file in enumerate(listInputPosteriorsFiles):
            ...
            if (args.removeTracheaResMetrics):
                ...
                in_reference_array = MaskOperator.substract_two_masks(in_reference_array, in_coarseairways_array)
    ...
    for iter in range(num_iterEvaluate_max):
        ...
        with tqdm(total=num_validpred_files) as progressbar:
            ...
            for i, (in_posterior_array, in_referdata_array) in enumerate(zip(listin_posterior_array, listin_reference_array)):
                ...
                in_predictmask_array = ThresholdImage.compute(in_posterior_array, curr_thres_value)
                ...
                if (args.removeTracheaCalcMetrics):
                    ...
                    in_predictdata_array = MaskOperator.substract_two_masks(in_predictdata_array, in_coarseairways_array)
                # **********************************************
...
if __name__ == "__main__":
    ...
    parser.add_argument('--removeTracheaResMetrics', type=str2bool, default=IS_REMOVE_TRACHEA_CALC_METRICS)
