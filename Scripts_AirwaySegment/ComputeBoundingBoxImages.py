...
if __name__ == "__main__":
    ...
    parser.add_argument('--nameOutputBoundingBoxesFile', type=str, default=NAME_CROP_BOUNDINGBOX_FILE)
    parser.add_argument('--isTwoBoundingBoxEachLungs', type=str2bool, default=IS_TWO_BOUNDBOX_EACH_LUNGS)
    parser.add_argument('--sizeBufferInBorders', type=str2tuple_int, default=SIZE_BUFFER_BOUNDBOX_BORDERS)
    parser.add_argument('--sizeTrainImages', type=str2tuple_int, default=SIZE_IN_IMAGES)
    parser.add_argument('--isSameSizeBoundBoxAllImages', type=str2bool, default=IS_SAME_SIZE_BOUNDBOX_ALL_IMAGES)
    parser.add_argument('--fixedSizeBoundingBox', type=str2tuple_int, default=FIXED_SIZE_BOUNDING_BOX)
    parser.add_argument('--isCalcBoundingBoxInSlices', type=str2bool, default=IS_CALC_BOUNDINGBOX_IN_SLICES)
