...
def main(args):
    ...
    for i, in_image_file in enumerate(listInputImagesFiles):
        ...
        in_cropimage_array = ImageFileReader.get_image(in_image_file)
        ...
        out_fullimage_shape = ImageFileReader.get_image_size(in_referkey_file)
        out_fullimage_array = ExtendImage._compute3D(in_cropimage_array, in_bounding_box, out_fullimage_shape)
        ...
        ImageFileReader.write_image(out_image_file, out_fullimage_array, metadata=inout_metadata)
    #endfor
