...
class BoundingBoxes(object):
    ...
    @staticmethod
    def get_max_size_bounding_box(size_bounding_box, max_size_bounding_box):
    ...
    @staticmethod
    def get_min_size_bounding_box(size_bounding_box, min_size_bounding_box):
    ...
    @staticmethod
    def is_bounding_box_contained_in_image_size(in_bounding_box, size_image):
    ...
    @staticmethod
    def is_image_patch_contained_in_bounding_box(size_in_bounding_box, size_image):
    ...
    @staticmethod
    def fit_bounding_box_to_image(in_bounding_box, size_image):
    ...
    @staticmethod
    def enlarge_bounding_box_to_image(in_bounding_box, size_image):
    ...
    @classmethod
    def translate_bounding_box_fit_image_size(cls, in_bounding_box, size_image):
    ...
    @classmethod
    def compute_bounding_boxes_crop_extend_image(cls, in_bounding_box, size_image):

        out_crop_bounding_box = cls.fit_bounding_box_to_image(in_bounding_box, size_image)
    ...
    @classmethod
    def compute_bounding_boxes_crop_extend_image_reverse(cls, in_bounding_box, size_image):

        (out_extend_bounding_box, out_crop_bounding_box) = cls.compute_bounding_boxes_crop_extend_image(in_bounding_box, size_image)
